...
#include "HAL_UcosIII_Class.h"
#include <AP_HAL_Empty/AP_HAL_Empty_Private.h>
#include <AP_HAL_UcosIII/AP_HAL_UcosIII_Private.h>
...
void HAL_UcosIII::run(int argc, char * const argv[], Callbacks* callbacks) const
{
    /*
...
const AP_HAL::HAL& AP_HAL::get_HAL() {
    static const HAL_UcosIII hal_chibios;
    return hal_chibios;
}
